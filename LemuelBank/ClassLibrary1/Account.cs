...
namespace ClassLibrary1
{
    public class Account
    {
        ...
        public virtual void Deposit(decimal amount)
        {
            ...
            {
                throw new ArgumentException("Error - Deposit amount must be positive or inactive.");
            }
            Balance += amount;
            transactionHistory.Add($"Beposited: {amount:C} on {DateTime.Now}");
        }
        ...
        {
            return $"Acount Number: {AccountNumber}, Owner; {OwnerName}, Balance {Balance:C}, Active: {IsActive}, Opened On: {DateOpened}, Type: {TypeOfAccount}";
        }
